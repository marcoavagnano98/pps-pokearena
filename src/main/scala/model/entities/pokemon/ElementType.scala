...
enum ElementType :
  case Normal, Fire, Water, Grass, Flying, Fighting, Poison, Electric, Ground, Rock, Psychic, Ice, Bug, Ghost, Steel, Dragon, Dark, Fairy
...
object ComparatorTypeElement:
  ...
  def apply(e1: ElementType,e2: ElementType) : Double =
    allTypeComparator(e1).getOrElse(e2,1.0)
